...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		//Lili eventos
		['Quitar darkscreen intro', "Esto es para quitar la pantalla negra al incio de las canciones\nValue 1: La velocidad de desvanecimiento"],
		['Strum visibilidad', "Value 1: De quien? (dad, bf, gf)\nvalue 2: La transparencia\nValue 3: La velocidad de desvanecimiento"],
		['Zoom', "Value 1: Zoom hacia el que va a cambiar\nValue 2: true/false para zoom repentino, o\n valor numerico para la duracion"],
		['Vignette', "Para quitar y poner el vignette negro\nValue 1: El aplha del vignette\nValue 2: La velocidad del alpha"],
		['Camera Flash', "Value 1: 4 últimos dijitos del color en rgb. EJ: blanco = ffff\nValue 2: Tiempo de desvanecimiento en seg\n el negro es 000000 (ceros)"],
		['UI on/off', "Esto quita la ui, menos los strums\nValue 1: True o false"],
		['3rdstrum', "Value 1: true para activar\nfalse para desactivar\nTODO EN VALUE 1"],
		['Pantalla negra', "Se explica solo\nValue 1: Transparencia del overlay\nValue 2: La velocidad a la que se aplica"],
		['Red Vignette', "Value 1: Alpha del vignette\nValue 2: La velocidad del alpha"]
	];
	...
	function addSongUI():Void
	{
		...
		for (i in 0...directories.length) {
			...
			if(FileSystem.exists(directory)) {
				for (file in SUtil.readDirectory(directory)) {
