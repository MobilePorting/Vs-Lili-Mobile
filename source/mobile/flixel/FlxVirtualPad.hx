...
class FlxVirtualPad extends FlxSpriteGroup
{
	...
	public function new(DPad:FlxDPadMode, Action:FlxActionMode):Void
	{
		...
		switch (Action)
		{
			...
			case P:
				add(buttonP = createButton(FlxG.width - 132, 0, 'p', 0xE5DE00));
			case A_B:
	...
	private function createButton(X:Float, Y:Float, Graphic:String, Color:Int = 0xFFFFFF):FlxButton
	{
		...
		if (Assets.exists('assets/shared/images/virtualpad/${Graphic}.png'))
			graphic = FlxG.bitmap.add('assets/shared/images/virtualpad/${Graphic}.png');
		else
			graphic = FlxG.bitmap.add('assets/shared/images/virtualpad/default.png');
