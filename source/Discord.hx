...
class DiscordClient
{
	...
	private static final _defaultID:String = "1062744391426510969";
	...
	public static function changePresence(?details:String = 'In the Menus', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		presence.largeImageKey = 'lili';
		presence.largeImageText = "Game Version: " + MainMenuState.psychEngineVersion;
	...
	public static function addLuaCallbacks(funk:FunkinLua) {
		funk.set("changePresence", function(details:String, state:Null<String>, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float) {
